...
CREATE TABLE pilot (id INT NOT NULL PRIMARY KEY,
...
CREATE TABLE airport (id INT NOT NULL PRIMARY KEY,
 name VARCHAR(45) NOT NULL,
 city_id INT NOT NULL,
 CONSTRAINT fk_city_id FOREIGN KEY(city_id) REFERENCES city(id)) ENGINE=InnoDB;

CREATE TABLE terminal (id INT NOT NULL PRIMARY KEY,
 number INT NOT NULL,
...
CREATE TABLE plane (id INT NOT NULL PRIMARY KEY,
...
CREATE TABLE flight (id INT NOT NULL PRIMARY KEY,
